<template>
  <div class="scrolling-wrapper">
    <draggable v-model="lists" :handle="getDragHandle" :disabled="!shouldAllowListOrder" group="kanban-board-lists" class="row flex-nowrap mt-1">
      <List v-for="(listItem, index) in lists" :key="index" :board="getBoard" :list="listItem"></List>
    </draggable>
  </div>
</template>
<script>
