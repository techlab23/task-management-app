   ...
   <div class="col-xs-12 col-sm-6 col-md-3 d-flex pb-3" v-for="board in unarchivedBoards" :key="board.id">
    <div class="card w-100">
     ...
     <div class="card-footer bg-transparent">
      <router-link class="btn btn-sm btn-app mr-2 mb-1" :to="{ name: 'board', params: { id: board.id } }"
       >View</router-link
      >
   ...
   <div class="col-xs-12 col-sm-6 col-md-3 d-flex pb-3" v-for="board in archivedBoards" :key="board.id">
    <div class="card w-100">
     ...
     <div class="card-footer bg-transparent text-center">
      <button class="btn btn-sm btn-success" @click="unArchiveBoard({ boardId: board.id })">
       Restore
      </button>
     </div>
    </div>
