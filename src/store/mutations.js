...
export default {
  ...
  SAVE_BOARD(state, payload) {
    ...
    // For new item
      ...
      const board = { id: guid(), name: payload.name, description: payload.description, archived: false, lists: [] }
  ...
  SAVE_LIST(state, payload) {
    ...
    // // For new item
      ...
      const list = { id: guid(), name: payload.name, headerColor: "#607d8b", archived: false, items: [] }
