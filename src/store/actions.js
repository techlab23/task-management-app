...
export default {
  async fetchData({ commit }) {
    ...
    return axios.get(INITIAL_DATA_URL)
      .then(res => {
        window.setTimeout(() => {
  ...
  async unArchiveBoard({ commit }, payload) {
    commit('UNARCHIVE_BOARD', payload)
  },
  ...
  async unArchiveList({ commit }, payload) {
    commit('UNARCHIVE_LIST', payload)
  },
