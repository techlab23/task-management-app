<template>
 <RenderlessItem
  :item="item"
  @item-editing="() => $emit('item-editing')"
  @item-edited="item => $emit('item-edited', item)"
  @item-cancelled="() => $emit('item-cancelled')"
 >
  <template
   v-slot="{
    item,
    ...
    <div class="card-body">
     ...
     <div class="form">
      ...
      <div class="form-group text-center">
       <button class="btn btn-outline-primary btn-sm mr-2" @click.prevent="save">
        Save
       </button>
